<template>
  <div>
    <v-app-bar app>
      <v-toolbar-title> PickUp </v-toolbar-title>
      <v-spacer></v-spacer>
      <v-toolbar-items>
        <v-btn class="newButton">
        <v-switch v-model="$vuetify.theme.dark" class="mt-5"></v-switch>
      ...
      <v-toolbar-items text class="hidden-xs-only">
        <inertia-link
          ...
          "
        >
          <v-btn text color="blue" class="newButton"> Home </v-btn>
        </inertia-link>
      </v-toolbar-items>
      ...
      <v-toolbar-items v-if="$page.props.user" text class="hidden-xs-only">
        <inertia-link
          ...
          "
        >
          <v-btn text color="blue" class="newButton"> Dashboard </v-btn>
        </inertia-link>
      ...
      <v-toolbar-items v-else text class="hidden-xs-only">
        <inertia-link
          ...
          "
        >
          <v-btn text color="blue" class="newButton"> Login </v-btn>
        </inertia-link>
        ...
        <inertia-link
          ...
          "
        >
          <v-btn text color="blue" class="newButton"> Register </v-btn>
        </inertia-link>
      </v-toolbar-items>
    ...
    <v-navigation-drawer v-model="drawer" temporary app right>
      <v-list nav dense v-if="$page.props.user">
        <v-list-item-group v-model="group">
          ...
          <v-list-item>
            <v-btn text class="sideButton">
              <v-icon color="blue lighten-3" left small>
                mdi-speedometer
              </v-icon>
              <inertia-link
                :href="route('dashboard')"
